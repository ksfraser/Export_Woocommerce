...
class woo_tax_lines extends woo_interface {
	...
	{
		$this->fields_array[] = array('name' => 'woo_tax_lines_id', 	'type' => 'int(11)', 		'comment' => 'Index.', 'readwrite' => 'read', 'auto_increment' => 'anything');
